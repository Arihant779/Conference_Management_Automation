...
def run_dashboard_test():
    print("Starting dashboard load time test to http://localhost:5000/dashboard...")
    ...
    try:
        ...
        if duration <= 3:
            print("PASS: Dashboard loaded within 3 seconds.")
        else:
            print("FAIL: Dashboard took longer than 3 seconds.")
